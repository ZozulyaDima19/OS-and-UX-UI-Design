...
- призупинити виконання команди top (CTRL+Z);
...
Під час виконання лабораторної роботи було отримано практичні навики роботи з командною оболонкою Bash та розглянуто основні команди для управління процесами в Linux. Було досліджено роботу команд ps, top, kill, killall, а також механізми керування фоновими та передніми процесами.
